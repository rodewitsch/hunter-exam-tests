  ...
  return (
    <View>
      ...
      <ScrollView style={styles.navigation}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=1')}>
          <Text style={styles.navigationItemTitle}>
            Основы классификации животного мира. Классификация дичи. Охраняемые дикие животные
          </Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=2')}>
          <Text style={styles.navigationItemTitle}>Основы биологии охотничьих животных</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=3')}>
          <Text style={styles.navigationItemTitle}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=4')}>
          <Text style={styles.navigationItemTitle}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=5')}>
          <Text style={styles.navigationItemTitle}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=6')}>
          <Text style={styles.navigationItemTitle}>Сроки и способы охоты</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=7')}>
          <Text style={styles.navigationItemTitle}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=8')}>
          <Text style={styles.navigationItemTitle}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=9')}>
        ...
        <TouchableOpacity style={styles.navigationItem} onPress={() => router.navigate('/training/process?topic=10')}>
          <Text style={styles.navigationItemTitle}>
